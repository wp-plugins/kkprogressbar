			...
			<div class="kkadmin-tresc">
				...
				<table id="kkpb-table" class="widefat fixed" cellspacing="0">
			        <thead><tr class="thead">
			            ...
			            <th style="width: 20px;"><img src="<?php echo WP_PLUGIN_URL; ?>/kkprogressbar/images/aktywny.png" alt="" /></th>
			            <th style="width: 20px;"><img src="<?php echo WP_PLUGIN_URL; ?>/kkprogressbar/images/wstrzymany.png" alt="" /></th>
			            <th style="width: 20px;"><img src="<?php echo WP_PLUGIN_URL; ?>/kkprogressbar/images/nieaktywny.png" alt="" /></th>
			        ...
			        foreach ($rows as $row) {
			            ...
			            <tr class="alternate" id="kkpb-row-<?php echo $row->id; ?>">
			                ...
			                <td><?php echo stripslashes($row->opis); ?></td>
