...
<div class="wrap">
	...
	<div id="kkadmin-menu">
		<ul id="kkadmin-menu-ul">
				...
				<li><a href="/wp-admin/admin.php?page=kkpb-settings" class="active"><img src="<?php echo WP_PLUGIN_URL; ?>/kkprogressbar/images/blog_up.png" alt="" style="vertical-align: middle; margin-right: 15px;" /> <?php echo __('Settings','lang-kkprogressbar'); ?></a></li>
